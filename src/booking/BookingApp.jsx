      ...
      <main className="mx-auto w-full max-w-3xl px-4 pb-16 pt-8 sm:px-6 sm:pt-12">
        ...
        {step === 4 && (
          <form className="mt-8" onSubmit={submitBooking}>
            ...
            <p className="mt-4 text-xs leading-5 text-zinc-500">Ao confirmar, você autoriza o uso dos dados informados para organizar esta reserva e declara que leu a <a href="/politica-de-privacidade" target="_blank" rel="noreferrer" className="font-bold text-[#8e3158] underline">Política de Privacidade</a> e os <a href="/termos-de-uso" target="_blank" rel="noreferrer" className="font-bold text-[#8e3158] underline">Termos de Uso</a>.</p>
