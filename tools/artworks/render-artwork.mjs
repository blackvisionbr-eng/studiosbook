...
export function YouTubeProfile({ assets }) {
  return `<div id="artboard" class="artboard kind-youtube-profile" style="--w:800px;--h:800px">
    <div class="profile-safe-ring"></div>
    <div class="profile-mark"><img src="${assets.markReversed}" alt="Símbolo StudiosBook" /></div>
  </div>`;
}

export function YouTubeBanner({ assets }) {
  return `<div id="artboard" class="artboard kind-youtube-banner" style="--w:2560px;--h:1440px">
    <div class="banner-grid"></div>
    <div class="banner-petal banner-petal-left"></div>
    <div class="banner-petal banner-petal-right"></div>
    <div class="banner-safe-content">
      <div class="banner-brand">
        ${BrandLogo({ logoDataUri: assets.logo })}
        <span>SEU TALENTO EM FOCO. SEU STUDIO SOB CONTROLE.</span>
      </div>
      <div class="banner-divider"></div>
      <div class="banner-message">
        <span>TUTORIAIS OFICIAIS</span>
        <h1>Aprenda. Organize. Cresça.</h1>
        <p>Gestão prática para profissionais da beleza.</p>
        <strong>studiosbook.com.br</strong>
      </div>
    </div>
  </div>`;
}
...
function baseStyles(assets) {
  return `
    ...
    *{box-sizing:border-box}html,body{margin:0;background:transparent}body{font-family:"DM Sans",Arial,sans-serif;color:var(--ink)}svg{display:block}.artboard{position:relative;width:var(--w);height:var(--h);overflow:hidden;background:var(--ivory);isolation:isolate}.artboard h1,.artboard p{margin:0}.texture-lines{position:absolute;inset:0;z-index:-2;background-image:linear-gradient(rgba(64,34,57,.045) 1px,transparent 1px),linear-gradient(90deg,rgba(64,34,57,.045) 1px,transparent 1px);background-size:56px 56px;mask-image:linear-gradient(90deg,#000,transparent 70%)}
    ...
    .kind-youtube-profile{display:grid;place-items:center;background:var(--plum-dark)}.kind-youtube-profile:before,.kind-youtube-profile:after{content:"";position:absolute;width:330px;height:330px;border-radius:68% 18% 68% 18%;background:#573048}.kind-youtube-profile:before{left:-150px;top:-135px;transform:rotate(18deg)}.kind-youtube-profile:after{right:-150px;bottom:-135px;transform:rotate(198deg)}.profile-safe-ring{position:absolute;inset:74px;border:2px solid rgba(255,255,255,.1);border-radius:50%}.profile-mark{position:relative;z-index:2;width:420px;height:420px;display:grid;place-items:center}.profile-mark img{display:block;width:100%;height:100%;object-fit:contain}
    .kind-youtube-banner{background:var(--ivory)}.banner-grid{position:absolute;inset:0;background-image:linear-gradient(rgba(64,34,57,.035) 1px,transparent 1px),linear-gradient(90deg,rgba(64,34,57,.035) 1px,transparent 1px);background-size:72px 72px;mask-image:linear-gradient(90deg,transparent,#000 30%,#000 70%,transparent)}.banner-petal{position:absolute;width:690px;height:690px;border-radius:68% 18% 68% 18%}.banner-petal-left{left:-300px;top:365px;background:var(--plum);transform:rotate(20deg)}.banner-petal-right{right:-270px;top:270px;background:var(--blush);transform:rotate(200deg)}.banner-safe-content{position:absolute;left:507px;top:508px;width:1546px;height:423px;display:grid;grid-template-columns:480px 1px 1fr;align-items:center;gap:62px}.banner-brand{display:flex;flex-direction:column;align-items:flex-start;gap:34px}.banner-brand .brand-logo img{width:460px}.banner-brand>span{max-width:430px;color:var(--rose);font-size:18px;font-weight:800;line-height:1.45;letter-spacing:1.3px}.banner-divider{width:1px;height:246px;background:var(--line)}.banner-message{display:flex;flex-direction:column;align-items:flex-start}.banner-message>span{margin-bottom:16px;color:var(--rose);font-size:19px;font-weight:800;letter-spacing:2px}.banner-message h1{font-family:"DM Serif Display",Georgia,serif;color:var(--plum-dark);font-size:72px;font-weight:400;line-height:1;white-space:nowrap}.banner-message p{margin-top:18px;color:var(--muted);font-size:27px;line-height:1.35}.banner-message strong{margin-top:24px;color:var(--plum);font-size:20px}
